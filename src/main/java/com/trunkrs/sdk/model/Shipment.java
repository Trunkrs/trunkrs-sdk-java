...
public abstract class Shipment extends ApiResource {
   ...
   * @return The newly created shipments. In case of a multiple parcels this will return multiple shipment models.
   ...
   */
  @SneakyThrows(UnsupportedVersionException.class)
  public static List<Shipment> retrieve(int page) throws NotAuthorizedException, GeneralApiException {
