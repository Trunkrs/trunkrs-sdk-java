...
public class APIV1ShipmentRetrieveTest extends APIV1BaseTest {
  ...
  public void requestsRightResources(int expectedPage)
    ...
    mockResponseCallback(
        request -> {
          assertThat(request.getUrl()).endsWith(String.format("shipments?page=%d", expectedPage));
  ...
  public void executesGetRequest() throws NotAuthorizedException, GeneralApiException {
    mockResponseCallback(
        request -> {
  ...
  public void returnsListOfShipments() throws NotAuthorizedException, GeneralApiException {
    ...
    assertThat(result.get(0)).isInstanceOf(APIV1Shipment.class);
  }
}
