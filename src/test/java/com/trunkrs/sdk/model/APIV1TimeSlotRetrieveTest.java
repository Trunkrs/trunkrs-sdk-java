...
public class APIV1TimeSlotRetrieveTest extends APIV1BaseTest {
  ...
  public void callsTheRightEndpoint()
    ...
    mockResponseCallback(request -> {
      assertThat(request.getUrl())
        .endsWith(String.format("timeslots?country=%s", countryCode));

      return ApiResponse.builder()
        .status(200)
        .body(getJsonFixture("time_slots.json"))
        .build();
    });
  ...
  public void parsesRightInfo()
    ...
    assertThat(timeSlots.size())
      .isEqualTo(1);

    val timeSlot = timeSlots.get(0);
    assertThat(timeSlot.getId())
      .isEqualTo(1001);
