...
public class APIV1WebHookUnregisterTest extends APIV1BaseTest {
  ...
  public void makesRightCallToEndpoint()
    ...
    mockResponseCallback(
        request -> {
          assertThat(request.getUrl()).endsWith(String.format("webhooks/%d", webHookId));
  ...
  public void throwsWhenNotFound() {
    ...
    assertThatThrownBy(() -> WebHook.unregister(100)).isInstanceOf(WebHookNotFoundException.class);
  }
}
