...
public class APIV1WebhookRetrieveTest extends APIV1BaseTest {
  ...
  public void makesCallToRightEndpoint() throws NotAuthorizedException, GeneralApiException {
    mockResponseCallback(request -> {
      ...
      return ApiResponse.builder()
        .status(200)
        .body(getJsonFixture("web_hooks.json"))
        .build();
    });
  ...
  public void parsesTheRightInfo()
    throws NotAuthorizedException, GeneralApiException {
    ...
    assertThat(webHook1.getId())
      .isEqualTo(1337);
    assertThat(webHook1.getSessionHeaderName())
      .isEqualTo("X-Funky-Business");
    assertThat(webHook1.getEventType())
      .isEqualTo(EventType.onStateUpdate);
    assertThat(webHook2.getEventType())
      .isEqualTo(EventType.onCancellation);
  }
}
