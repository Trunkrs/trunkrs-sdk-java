...
public class ShipmentStateFindTest extends APIV1BaseTest {
  ...
  public void makesRequestToEndpoint()
    ...
    mockResponseCallback(request -> {
      assertThat(request.getUrl())
        .endsWith(String.format("state/%d", shipmentId));
  ...
  public void getsRightInformation()
    ...
    assertThat(state.getShipmentId())
      .isEqualTo(100);
    assertThat(state.getStateCode())
      .isEqualTo(StateCode.shipmentNotDelivered);
    assertThat(state.getReasonCode())
      .isEqualTo(StateReasonCode.parcelMissing);
    assertThat(state.getPackageOwner().getOwnerType())
      .isEqualTo(OwnerType.trunkrs);
    assertThat(state.getPackageOwner().getName())
      .isEqualTo("Trunkrs B.V.");
    assertThat(state.getPackageOwner().getAddressLine())
      .isEqualTo("Liesbosch 90");
    assertThat(state.getPackageOwner().getPostalCode())
      .isEqualTo("3439 LC");
    assertThat(state.getPackageOwner().getCity())
