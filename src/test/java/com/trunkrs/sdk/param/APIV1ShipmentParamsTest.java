...
public class APIV1ShipmentParamsTest extends APIV1BaseTest {
  ...
  public void createsRightInstance()
    throws ShipmentWithoutParcelsException {
  ...
  public void setsPickUpAddress()
    throws ShipmentWithoutParcelsException {
    val address = Mocks.getFakeAddress();
    val parcel = Mocks.getFakeParcel();

    val params = ShipmentParams.builder()
  ...
  public void setsDeliveryAddress()
    throws ShipmentWithoutParcelsException {
    val address = Mocks.getFakeAddress();
    val parcel = Mocks.getFakeParcel();
