...
public class APIV1WebHookParamsTest extends APIV1BaseTest {
  ...
  public void setsWebHookInfo() {
    ...
    val params = WebHookParams.builder()
  ...
  public void appliesOnCreationEvent() {
    val params = WebHookParams.builder()
      .event(EventType.onCreation)
      .build();

    assertThat(params)
      .hasFieldOrPropertyWithValue("onCreation", true);
  }
  ...
  public void appliesOnStateUpdateEvent() {
    ...
    assertThat(params)
      .hasFieldOrPropertyWithValue("onStatusUpdate", true);
  }
  ...
  public void appliesOnCancellationEvent() {
    val params = WebHookParams.builder()
      .event(EventType.onCancellation)
      .build();

    assertThat(params)
      .hasFieldOrPropertyWithValue("onCancellation", true);
  }
}
